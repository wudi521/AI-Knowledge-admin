      ...
      <div class="flex min-h-0 flex-1 flex-col">
        ...
        <div class="flex min-h-0 flex-1 gap-3">
          ...
          <div
            ...
            class="border-border flex w-60 shrink-0 flex-col border-l border-solid pl-3"
          >
            <div class="mb-2 flex shrink-0 items-center justify-between">
              <span class="font-medium">快捷项目</span>
              <ElTooltip content="收起快捷项目" placement="top">
                <ElButton circle @click="quickPanelCollapsed = true">
          ...
          <div
            v-else
            class="border-border w-9 shrink-0 border-l border-solid pl-2"
          >
            <ElTooltip content="展开快捷项目" placement="top">
              <ElButton circle @click="quickPanelCollapsed = false">
