...
<template>
  <Page auto-content-height>
    ...
    <div class="mb-4 flex items-center justify-between">
      <ElButton link type="primary" @click="close">返回薪资档案</ElButton>
    ...
    <div v-loading="loading" class="mt-4">
      <ElTabs v-model="activeTab">
        <ElTabPane label="薪资档案" name="salaryEmployee">
          <InfoDetails :salary-employee="salaryEmployee" />
        </ElTabPane>
        <ElTabPane label="调薪记录" lazy name="records">
          <ChangeRecordList
