  ...
  return [
    {
      ...
      label: '员工姓名',
      component: 'Input',
      componentProps: { clearable: true, placeholder: '请输入员工姓名' },
    },
    {
      fieldName: 'jobNumber',
      label: '工号',
      component: 'Input',
      componentProps: { clearable: true, placeholder: '请输入工号' },
    },
  ];
}
...
<template>
  <ElDialog v-model="open" destroy-on-close title="选择员工" width="960px">
    ...
    <Grid>
      <template #radio="{ row }">
        <ElRadioGroup v-model="selectedRadioId">
          <ElRadio
