...
import { Button, Dropdown, Menu, message, Table, Tabs } from 'antdv-next';
...
// 模板分类页签（antdv-next 页签 key 仅支持字符串）
    ...
    <div class="mb-4 flex items-center gap-5">
      ...
      >
        ...
        <template #popupRender>
          <Menu>
            <Menu.Item key="template" @click="handleCreate('template')">
              新增模板
            </Menu.Item>
            <Menu.Item key="scheme" @click="handleCreate('scheme')">
              新增方案
            </Menu.Item>
          </Menu>
        </template>
